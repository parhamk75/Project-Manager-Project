...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/home/parhamk75/GitHub/Self_Fun_Projects/Project-Manager-Project/UI/../ICONS/App_Icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/home/parhamk75/GitHub/Self_Fun_Projects/Project-Manager-Project/UI/../ICONS/Bio-Engine.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBox_Label.addItem(icon1, "")
        self.comboBox_Label.addItem("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/home/parhamk75/GitHub/Self_Fun_Projects/Project-Manager-Project/UI/../ICONS/INILAB.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBox_Label.addItem(icon2, "")
